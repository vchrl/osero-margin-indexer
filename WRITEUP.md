...
Answer: **no**. As of pinned block 25758109: current margin ≈ **-27.1 bps**
annualized; cumulative net **-171.51 USDS** since the 2026-07-24 entry (earned
1,289.29 in supply yield, owed 1,460.80 to Sky) over 21.8 days on the
2,002,289.29 USDS deployed. Everything below reconciles against chain state at that block.
...
Generated from dashboard/reconciliation.json at reconcile time (run 14, pinned block 25758109):
...
| `3_sum_revenue_eq_balance_growth` | blocking | pass | 345 | 722 |
...
| `8_DIAGNOSTIC_rate_integral_vs_index_revenue` | diagnostic | pass | 346 | 6446455469429193103 |
| `10_cost_sql_recomputation` | blocking | pass | 58597560102108 | 20000000000000000 |
