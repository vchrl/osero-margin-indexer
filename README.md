...
<!-- headline:start -->
**Is Osero making money?** As of block 25765277 (reconcile run 16): **NO.**
Current margin ≈ **-27.1 bps** annualized; cumulative net **-186.35 USDS**
since the 2026-07-24 entry on the 2,002,400.95 USDS position, losing ≈ **$8.16/day**
over **22.8** days. Structurally: margin per unit deployed =
...
Latest run (reconcile run 16, pinned block 25765277), generated from
