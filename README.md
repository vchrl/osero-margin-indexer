...
<!-- headline:start -->
**Is Osero making money?** As of block 25722543 (reconcile run 4): **NO.**
Current margin ≈ **-27.1 bps** annualized; cumulative net **-123.80 USDS**
since the 2026-07-24 entry on the 1,001,930.61 USDS position, losing ≈ **$7.34/day**
over **16.9** days. Structurally: margin per unit deployed =
...
Latest run (reconcile run 4, pinned block 25722543), generated from
