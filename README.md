...
<!-- headline:start -->
**Is Osero making money?** As of block 25729613 (reconcile run 6): **NO.**
Current margin ≈ **-27.1 bps** annualized; cumulative net **-131.13 USDS**
since the 2026-07-24 entry on the 1,001,985.73 USDS position, losing ≈ **$7.34/day**
over **17.9** days. Structurally: margin per unit deployed =
...
Latest run (reconcile run 6, pinned block 25729613), generated from
