...
<!-- headline:start -->
**Is Osero making money?** As of block 25772493 (reconcile run 18): **NO.**
Current margin ≈ **-27.1 bps** annualized; cumulative net **-201.27 USDS**
since the 2026-07-24 entry on the 2,002,513.10 USDS position, losing ≈ **$8.44/day**
over **23.8** days. Structurally: margin per unit deployed =
...
Latest run (reconcile run 18, pinned block 25772493), generated from
