...
<!-- headline:start -->
**Is Osero making money?** As of block 25736866 (reconcile run 8): **NO.**
Current margin ≈ **-27.1 bps** annualized; cumulative net **-138.66 USDS**
since the 2026-07-24 entry on the 1,002,042.35 USDS position, losing ≈ **$7.35/day**
over **18.9** days. Structurally: margin per unit deployed =
...
Latest run (reconcile run 8, pinned block 25736866), generated from
