...
<!-- headline:start -->
**Is Osero making money?** As of block 25758109 (reconcile run 14): **NO.**
Current margin ≈ **-27.1 bps** annualized; cumulative net **-171.51 USDS**
since the 2026-07-24 entry on the 2,002,289.29 USDS position, losing ≈ **$7.85/day**
over **21.8** days. Structurally: margin per unit deployed =
...
Latest run (reconcile run 14, pinned block 25758109), generated from
